/* Draft War Room layout + draft-speed controls.
   Existing drafting/state logic remains in app.js. */

/* ---------- Quick Select / Undo controls ---------- */
...
/* Override the standard click behavior:
   - Quick Select ON: assign directly to current pick manager.
   - Quick Select OFF: use the original manager selection dialog.
   - Keeper Mode always uses the manager selection dialog. */
...
/* Keep header controls synced after state changes/renders. */
